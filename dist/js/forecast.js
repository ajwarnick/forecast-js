(function () {
  ...
  var e$1={read:function(e){return e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent)},write:function(e){return encodeURIComponent(e).replace(/%(2[346BF]|3[AC-F]|40|5[BDE]|60|7[BCD])/g,decodeURIComponent)}};function t$1(e){for(var t=1;t<arguments.length;t++){var r=arguments[t];for(var n in r)e[n]=r[n];}return e}var r$1=function r(n,o){function i(e,r,i){if("undefined"!=typeof document){"number"==typeof(i=t$1({},o,i)).expires&&(i.expires=new Date(Date.now()+864e5*i.expires)),i.expires&&(i.expires=i.expires.toUTCString()),r=n.write(r,e),e=encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape);var c="";for(var u in i)i[u]&&(c+="; "+u,!0!==i[u]&&(c+="="+i[u].split(";")[0]));return document.cookie=e+"="+r+c}}return Object.create({set:i,get:function(t){if("undefined"!=typeof document&&(!arguments.length||t)){for(var r=document.cookie?document.cookie.split("; "):[],o={},i=0;i<r.length;i++){var c=r[i].split("="),u=c.slice(1).join("=");'"'===u[0]&&(u=u.slice(1,-1));try{var a=e$1.read(c[0]);if(o[a]=n.read(u,a),t===a)break}catch(e){}}return t?o[t]:o}},remove:function(e,r){i(e,"",t$1({},r,{expires:-1}));},withAttributes:function(e){return r(this.converter,t$1({},this.attributes,e))},withConverter:function(e){return r(t$1({},this.converter,e),this.attributes)}},{attributes:{value:Object.freeze(o)},converter:{value:Object.freeze(n)}})}(e$1,{path:"/"});
  ...
  /* VUE DATA BINDING */
  gn.config.productionTip = false;
  gn.config.devtools=false;
